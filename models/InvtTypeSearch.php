...
/**
 * InvtTypeSearch represents the model behind the search form about `backend\modules\inventory\models\InvtType`.
 */
class InvtTypeSearch extends InvtType
{
    /**
     * @inheritdoc
     */
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'invt_tname', $this->invt_tname])
            ->andFilterWhere(['like', 'invt_tdetail', $this->invt_tdetail]);
