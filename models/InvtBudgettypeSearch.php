 ...
 */
class InvtBudgettypeSearch extends InvtBudgettype
{
    /**
     * @inheritdoc
     */
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'invt_bname', $this->invt_bname])
            ->andFilterWhere(['like', 'invt_bdetail', $this->invt_bdetail]);
