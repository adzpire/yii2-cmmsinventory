...
use backend\modules\dochub\models\FormInvttakeItems;

/**
 * FormInvttakeItemsSearch represents the model behind the search form about `backend\modules\dochub\models\FormInvttakeItems`.
 */
