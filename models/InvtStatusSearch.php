...
/**
 * InvtStatusSearch represents the model behind the search form about `backend\modules\inventory\models\InvtStatus`.
 */
class InvtStatusSearch extends InvtStatus
{
    /**
     * @inheritdoc
     */
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'invt_sname', $this->invt_sname])
            ->andFilterWhere(['like', 'invt_sdetail', $this->invt_sdetail]);
