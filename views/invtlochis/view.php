...
?>
<div class="invt-lochistory-view">
        ...
        'attributes' => [
 			[
				...
				//'format' => ['date', 'long']
     			...
     			[
				'label' => $model->attributeLabels()['invt_locID'],
				'value' => $model->invt_locID,			
				//'format' => ['date', 'long']
			],
     			[
			...
			[
				'label' => $model->attributeLabels()['update_by'],
				'value' => $model->updateBy->profile->fullname,
				//'format' => ['date', 'long']
			],
    	],
    ]) ?>
