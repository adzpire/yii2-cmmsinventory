...
/* @var $searchModel backend\modules\inventory\models\InvtTypeSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->params['breadcrumbs'][] = $this->title;
?>
<div class="invt-type-index">
    ...
    'gridOptions'=>[
        ...
        'responsive'=>true,
        'panel'=>[
            'heading'=> Html::icon('lamp').' '.Html::encode($this->title),
    ...
    'options'=>['id'=>'dynagrid-invttypeindex'] // a unique identifier is important
]); ?>
