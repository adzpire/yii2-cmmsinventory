        ...
        'attributes' => [
 			[
				...
				//'format' => ['date', 'long']
     			...
     			[
				'label' => $model->attributeLabels()['invt_sname'],
				'value' => $model->invt_sname,			
				//'format' => ['date', 'long']
			],
     			[
				'label' => $model->attributeLabels()['invt_sdetail'],
				'value' => $model->invt_sdetail,			
				//'format' => ['date', 'long']
			],
    	],
    ]) ?>
