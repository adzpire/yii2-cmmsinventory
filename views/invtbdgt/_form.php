...
<div class="invt-budgettype-form">

    <?php $form = ActiveForm::begin([
			'layout' => 'horizontal', 
			'id' => 'invt-budgettype-form',
			//'validateOnChange' => true,
            //'enableAjaxValidation' => true,
			//	'enctype' => 'multipart/form-data'
			]); ?>

    <?= $form->field($model, 'invt_bname')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'invt_bdetail')->textarea(['rows' => 6]) ?>
